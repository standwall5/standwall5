...
<img src="assets/GitHub_Invertocat_White.png" style="position: absolute; bottom: -2rem; right: -2rem; transform: rotate(-12deg); -webkit-mask-image: -webkit-gradient(linear, right bottom, left top, from(rgba(0,0,0,1)), to(rgba(0,0,0,0)));" width="225" />
</div>
